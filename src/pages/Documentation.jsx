      ...
      <div className="container mx-auto px-4 py-8 flex">
        ...
        <main className="flex-1" ref={contentRef}>
          ...
          <section id="overview" className="mb-16 scroll-mt-16">
            <h1 className="text-4xl font-bold mb-4">SignFlow API Documentation</h1>
              ...
              {[
                {
                  ...
                  url: "https://github.com/jacksonkhuto/signflow-js",
                  lang: "JavaScript",
                },
                {
                  name: "Python",
                  desc: "Async-enabled client with Pydantic models",
                  url: "https://github.com/jacksonkhuto/sigflow-py",
                  lang: "Python",
                },
                {
                  name: "Postman Collection",
                  desc: "Pre-configured API requests for testing",
                  url: "https://documenter.getpostman.com/view/12345678/sinflow-api",
                  lang: "API",
                },
                {
                  name: "OpenAPI Spec",
